...
const Stores = () => {
  ...
  const { data, loading, error } = useFetch("store/all", {
    headers: {
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {data?.data?.map((store) => (
                    <tr key={store.id}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="text-gray-900">{store?.Address ? store?.Address : "Null"}</div>
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      ...
                      <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        ...
                        >
                          Delate<span className="sr-only">, {store.name}</span>
                        </a>
                      </td>
                      {/* <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <a
